		...
		<table>
			<tbody>
				...
				<tr class="dot_line">
					...
					<td>
					   <input type="text" class="wd198" id="email" name="email" class="select" value="${member_info.email1 }" /> @ <input type="text" class="wd198" id="email_type" id="email_type" class="select" readonly="readonly" value="${member_info.email2 }" /> 
